...
4. Now when datting on DAT-o-MATIC in the Submit File page, drag and drop the file onto the page. **Not compatible with files that are more than 2 GB in size.**
