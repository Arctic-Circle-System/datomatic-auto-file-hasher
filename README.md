...
6. Wait for the hashes to auto-populate on-screen in the first set of fields (e.g. Decrypted). This may take a while for large files. **Not compatible with files that will >2 GB.**
