...
4. When datting on DAT-o-MATIC in the Submit File page, drag and drop the file onto the page. **This script is not compatible with files that are more than 2 GB in size.**
